...
mod test {
    ...
    async fn tmp2() {
        ...
        let prefetch_reader = PrefetchBuffer::new(reader.clone(), 1024 * 1024)
            .await
            .unwrap();
        ...
        //     &prefetch_reader,
        //     ifd_start,
        //     metadata_reader.bigtiff(),
        //     metadata_reader.endianness(),
        // )
        // .await
        // .unwrap();
        // ifd_reader.read(&prefetch_reader).await.unwrap();
        // dbg!("ifd", ifd);
